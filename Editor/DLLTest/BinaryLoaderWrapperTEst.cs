            ...
            {
                {
                    ...
                    Assert.IsTrue(result.errornr == 0, "Could not init Loader");

                    string file = "Test File";
                    result = bl.Create("TestFile", "Test", Encoding.ASCII.GetBytes(file), 9);
                    Assert.IsTrue(result.errornr == 0, "Could not create TestFile, Error: " + result.ToString());

                    string file2 = "Test File2";
                    result = bl.Create("TestFile2", "Test", Encoding.ASCII.GetBytes(file2), 10);
                    Assert.IsTrue(result.errornr == 0, "Could not create TestFile2, Error: " + result.ToString());
                    ...
                    UInt64 size = 0;
                    Assert.IsTrue(bl.GetSizeOfFile("TestFile", "Test", ref size).errornr == 0, "Could not get size of TestFile");
           
                    byte[] data = new byte[size];
                    Assert.IsTrue(bl.Read("TestFile", "Test", data, size).errornr == 0, "Could not read TestFile");
                    Assert.IsTrue(Encoding.ASCII.GetString(data) == "Test File", "Data in TestFile was " + Encoding.ASCII.GetString(data));

                    size = 0;
                    Assert.IsTrue(bl.GetSizeOfFile("TestFile2", "Test", ref size).errornr == 0, "Could not get size of TestFile2");
                    Assert.IsTrue(size == 10, "Size of TestFile was not 10");

                    data = new byte[size];
                    Assert.IsTrue(bl.Read("TestFile2", "Test", data, size).errornr == 0, "Could not read TestFile2");
                    ...
                    Assert.IsTrue(result.errornr == 0, "Could not get all files");
                    ...
                    Assert.IsTrue(result.errornr == 0, "Could not destroy TestFile");
                    ...
                    Assert.IsTrue(result.errornr == 0, "Could not create from file");
